...
<body style="background-image: url(&quot;assets/img/TCC.png&quot;);">
    ...
    <div class="container cool-btn-container">
        <div class="row">
            ...
            <button class="btn btn-success" type="button"  onclick="window.location.href='/HTML/AlunoJogar.php'">Jogar</button>
            <button class="btn btn-info" type="button"  onclick="window.location.href='/HTML/Media.php'">Visualizar Nota</button>
        </div>
