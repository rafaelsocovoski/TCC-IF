    ...
    <div class="container cool-btn-container">
        <div class="row">
            <div class="col-lg-2 offset-lg-4 d-flex flex-column py-3" style="margin:0 auto;">
              <button class="btn btn-secondary" type="button"  onclick="window.location.href='/HTML/CadastroAlunos.php'">Adicionar</button>
              <button class="btn btn-info" type="button"  onclick="window.location.href='/HTML/ViAluno.php'">Visualizar</button>
            </div>
