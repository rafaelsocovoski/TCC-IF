    ...
    <div class="container cool-btn-container">
        <div class="row">
          <div class="col-lg-2 offset-lg-4 d-flex flex-column py-3" style="margin:0 auto;">
            <button class="btn btn-primary" type="button" onclick="window.location.href='/HTML/CadastroTurmas.php'">Adicionar</button>
            <button class="btn btn-success" type="button" onclick="window.location.href='/HTML/ViTurma.php'">Visualizar</button>
          </div>
